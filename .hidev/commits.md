...
- Fixed Travis build
    - 5493c40 2016-03-31 phpcsfixed (sol@hiqdev.com)
    - 2c48fb3 2016-03-31 inited tests (sol@hiqdev.com)
    - ed8074e 2016-03-31 rehideved (sol@hiqdev.com)
    - b58e91d 2016-03-31 fixed travis build with `hiqdev/composer-asset-plugin` (sol@hiqdev.com)
- Fixed translation and minor issues
    - 421ddc2 2016-03-29 Add LastAnswer (andreyklochok@gmail.com)
    - acabfa2 2016-03-29 Added answer button to the botton of the view page (d.naumenko.a@gmail.com)
    - bb9ff7f 2016-03-28 Fixed ticket subsribtion/unsubscription when ticket is closed (d.naumenko.a@gmail.com)
    - 861d98e 2016-03-26 Translations updated (d.naumenko.a@gmail.com)
    - 6c0d614 2016-03-18 Fixed subsribe/unsubscribe button (d.naumenko.a@gmail.com)
    - b97b90e 2016-03-16 Added module-scope translations Ticket view - changed client info block to recepient date Other minor enh/fixes (d.naumenko.a@gmail.com)
    - 0e2e475 2016-03-16 Added missing translation (d.naumenko.a@gmail.com)
    - 31e1509 2016-02-02 Fixed standalone action to use updated api (andreyklochok@gmail.com)
    - e84ade9 2016-02-02 Fix visibility spen and `answer_spent` (andreyklochok@gmail.com)
    - 5a9e949 2016-01-18 Add subject and messgae search (andreyklochok@gmail.com)
    - f2c962a 2015-12-30 Reformat html in `_search` (andreyklochok@gmial.com)
    - fb35545 2015-12-17 Add OcticonsAsset, change markdown icon (andreyklochok@gmail.com)
    - 5ffe7e1 2015-12-17 Register OcticonsAsset in `_form` (andreyklochok@gmail.com)
    - de570b3 2015-12-09 Removed PHP short-tags (d.naumenko.a@gmail.com)
    - 0766630 2015-12-04 Classes notation changed from pathtoClassName to PHP 5.6 ClassName::class (d.naumenko.a@gmail.com)
    - eabf9a5 2015-11-27 Add link to answer (andreyklochok@gmail.com)
    - 78edf71 2015-11-26 Fix js (andreyklochok@gmail.com)
    - e7597ca 2015-11-26 When isNewRecord the form is visible (andreyklochok@gmail.com)
    - 9807bb9 2015-11-26 Change Save button color, remove from SidebarMenu Ticket Settings item (andreyklochok@gmail.com)
    - be9a2bb 2015-11-09 Removed options of Kartik\GridView (d.naumenko.a@gmail.com)
    - 5063858 2015-08-03 \Merge branch 'master' of git://github.com/hiqdev/hipanel-module-ticket (andreyklochok@gmail.com)
